...
st.write("""
🩺 This AI-powered Heart Disease Prediction Model helps you predict the **risk of heart disease** based on key health parameters like
**Age, Cholesterol, Blood Pressure, Glucose Level, BMI, etc.**. Early risk assessment can help in **preventive care**. 🚑💖Simply enter the required information, 
and the model will predict whether you are at risk or not.  
""")
st.markdown("---")  
